...
<div class="row">
	<div class="col-md-12 text-center">
		<h2>
			<a href="/Confs/newIndex?conf_id={{$conf_id}}"><button class="btn btn-default">Create another index</button></a>
			<a href="/sources/create?conf_id={{$conf_id}}"><button class="btn btn-default">Create another source</button></a>
			<a href="/searchds/create?conf_id={{$conf_id}}"><button class="btn btn-default">Define searchd settings</button></a>
		</h2>
