						...
						<div id="collapseOne" class="panel-collapse collapse">
							...
							{{ Form::open(array('action'=>'IndicesController@store', 'method'=>'post')) }}
								<div class='form-group'>
									...
									Name this Index (mandatory)</a></label>&nbsp;<span class='glyphicon glyphicon-question-sign redish' data-toggle="popover" title="name" data-content="Inherit options from other indexes, just add
									a ':' after the index name followed by the name of the index to inherit from."><br />
								...
								<div class='form-group'>
										...
										<textarea name='agent' placeholder='127.0.0.1:9306|127.0.0.1:9307:rt_test'  style="width:100%!important"></textarea>
								</div>
							</div>
						</div>
					</div>
						...
						<div id="collapseTwo" class="panel-collapse collapse">
							<div class="panel-body">
								<div class='form-group'>
										...
										<textarea name='agent_persistent' placeholder='127.0.0.1:9306|127.0.0.1:9307:rt_test'  style="width:100%!important"></textarea>
								</div>
								<div class='form-group'>
										...
										<textarea name='agent_blackhole' placeholder='127.0.0.1:9306|127.0.0.1:9307:rt_test'  style="width:100%!important"></textarea>
								</div>
								<div class='form-group'>
										...
										<textarea name='agent_connect_timeout' placeholder='300'  style="width:100%!important"></textarea>
								</div>
								<div class='form-group'>
										...
										<textarea name='agent_query_timeout' placeholder='10000'  style="width:100%!important"></textarea>
								</div>
							</div>
						</div>
					</div>
						...
						<div id="collapseThree" class="panel-collapse collapse">
							<div class="panel-body">
								<div class='form-group'>
										...
										<textarea name='ha_strategy' placeholder='nodeads'  style="width:100%!important"></textarea>
								</div>
								<div class='form-group'>
										...
										<textarea name='ha_period_karma' placeholder='120'  style="width:100%!important"></textarea>
								</div>
								<div class='form-group'>
										...
										<textarea name='ha_ping_interval' placeholder='1000'  style="width:100%!important"></textarea>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="panel panel-default">
			...
			<div id="collapseOne" class="panel-collapse collapse">
				<div class="panel-body">
					...
					<div class='form-group'>
							<label for='i_name'><a href='http://sphinxsearch.com/docs/current.html#confgroup-index'>
							Name this Index (mandatory)</a>&nbsp;<span class='glyphicon glyphicon-question-sign redish' data-toggle="popover" title="name" data-content="Inherit options from other indexes, just add
							a ':' after the index name followed by the name of the index to inherit from."></label><br />
			...
			<div id="collapseThree" class="panel-collapse collapse">
				<div class="panel-body">
					...
					<div class='form-group'>
							...
							</label><textarea type='text' name='html_index_attrs' placeholder='A comma separated list of in-field HTML/XML tags to index. Like this: h*, th, title. Requires html_strip = 1!' style="width:100%!important"></textarea>
					</div>
					<div class='form-group'>
							...
							</label><textarea type='text' name='index_zones' placeholder='A comma separated list of in-field HTML/XML tags to index. Like this: h*, th, title. Requires html_strip = 1!' style="width:100%!important"></textarea>
					</div>
				</div>
			</div>
		</div>
			...
			<div id="collapseFour" class="panel-collapse collapse">
				<div class="panel-body">
					<div class='form-group'>
									...
									<textarea type='text' name='morphology' placeholder='Comma separated list. Like this: stem_en, libstemmer_sv' style="width:100%!important"></textarea>
					</div>
					<div class='form-group'>
							...
							</label><input type='text' name='min_stemming_len' placeholder='4'">
					</div>
					<div class='form-group'>
							...
							</label><textarea type='text' name='stopwords' placeholder='/usr/local/sphinx/data/stopwords.txt' style="width:100%!important"></textarea>
					</div>
					<div class='form-group'>
							...
							<input type='text' name='wordforms' placeholder='/usr/local/sphinx/data/wordforms.txt' style="width:100%!important">
					</div>
					<div class='form-group'>
							...
							</label><input type='text' name='embedded_limit' placeholder='32K'">
					</div>
					<div class='form-group'>
							...
							<input type='text' name='exceptions' placeholder='/usr/local/sphinx/data/exceptions.txt' style="width:100%!important">
					</div>
				</div>
			</div>
		</div>
			...
			<div id="collapseOne" class="panel-collapse collapse">
				<div class="panel-body">
					...
					{{ Form::open(array('action'=>'IndicesController@store', 'method'=>'post')) }}
						<div class='form-group'>
							<label for='i_name'><a href='http://sphinxsearch.com/docs/current.html#confgroup-index'>
							Name this Index (mandatory)</a></label>
							&nbsp;<span class='glyphicon glyphicon-question-sign redish' data-toggle="popover" title="name" data-content="To inherit options from other indexes, just add
							a ':' after the index name followed by the name of the index to inherit from."><br />
						...
						<div class='form-group'>
							...
							</label><textarea type='text' name='rt_field' placeholder='rt_field = some_field, rt_field = some_other_field, etc..' style="width:100%!important"></textarea>
						</div>
					</div>
				</div>
			</div>
			...
			<div id="collapseTwo" class="panel-collapse collapse">
				<div class="panel-body">
					<div class='form-group'>
						...
						<textarea type='text' name='rt_attr' placeholder='rt_attr_uint = unsigned, rt_attr_json = json, etc..' style="width:100%!important"></textarea>
					</div>
					<div class='form-group'>
							<label for='docinfo'><a href='http://sphinxsearch.com/docs/current.html#conf-docinfo'>How to store Attributes</a>
			...
			<div id="collapseThree" class="panel-collapse collapse">
				<div class="panel-body">
					...
					<div class='form-group'>
							...
							<textarea type='text' name='stopwords' placeholder='/usr/local/sphinx/data/stopwords.txt' style="width:100%!important"></textarea>
					</div>
					<div class='form-group'>
							<label for='wordforms'><a href='http://sphinxsearch.com/docs/current.html#conf-wordforms'>Wordforms Dictionary</a>
			...
			<div id="collapseFour" class="panel-collapse collapse">
				<div class="panel-body">
					...
					<div class='form-group'>
							...
							<textarea type='text' name='html_index_attrs' placeholder='A comma separated list of in-field HTML/XML tags to index. Like this: h*, th, title. Requires html_strip = 1!' style="width:100%!important"></textarea>
					</div>
					<div class='form-group'>
							<label for='index_zones'><a href='http://sphinxsearch.com/docs/current.html#conf-index-zones'>Index HTML/XML zones (tags)</a>
							...
							<textarea type='text' name='index_zones' placeholder='A comma separated list of in-field HTML/XML tags to index. Like this: h*, th, title. Requires html_strip = 1!' style="width:100%!important"></textarea>
					</div>
				</div>
			</div>
		</div>
