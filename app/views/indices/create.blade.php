        		...
        		<h3 class="text-center">make a distributed index</h3>
					...
					<div class="panel panel-default">
						...
						<div id="collapseOne" class="panel-collapse collapse">
							...
							{{ Form::open(array('index'=>'IndicesController@store')) }}
								...
								<div class='form-group'>
									<input type='hidden' name='i_type' value="{{ $index_type }}">
								</div>
								<div class='form-group'>
	...
	<div class="col-md-4">
		...
		<div class="panel panel-default">
			...
			<div id="collapseOne" class="panel-collapse collapse">
				<div class="panel-body">
					...
					<div class='form-group'>
							<label for='i_s_name'><a href='http://sphinxsearch.com/docs/current.html#conf-sql-host'>Choose Source Name (mandatory)</a></label><br />
							<input type='text' name='i_s_name' placeholder='src1'>
					</div>
					<div class='form-group'>
							<label for='i_path'><a href='http://sphinxsearch.com/docs/current.html#conf-path'>Set index data directory (mandatory)</a></label><br />
							<input type='text' name='i_path' placeholder='/var/data/test'>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="panel panel-default">
			...
			<div id="collapseThree" class="panel-collapse collapse">
				<div class="panel-body">
					<div class='form-group'>
							<label for='i_sp'><a href='http://sphinxsearch.com/docs/current.html#conf-index-sp'>Index Sentence and Paragraph Boundaries</a></label><br />
							...
							<input type='text' name='i_sp' placeholder='1 or 0. 0 is default.'>
					</div>
					<div class='form-group'>
					...
					<div class='form-group'>
							<label for='i_zones'><a href='http://sphinxsearch.com/docs/current.html#conf-index-zones'>Index HTML/XML zones (tags)</a></label><br />
