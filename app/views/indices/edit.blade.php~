						...
						<div id="collapseOne" class="panel-collapse collapse">
							...
							{{ Form::model($indices, array('route' => array('indices.update', $indices->id), 'method' => 'put')) }}
								<div class='form-group'>
									...
									<input type='text' name='i_name' placeholder="{{$indices->i_name}}">
								</div>
								<div class='form-group'>
				...
				<div class="panel-body">
					...
					{{ Form::open(array('action'=>'IndicesController@store', 'method'=>'post')) }}
						...
						<div class='form-group'>
							...
							<textarea type='text' name='rt_field' placeholder="{{$indices->rt_field}}" style="width:100%!important"></textarea>
						</div>
					</div>
				</div>
			</div>
