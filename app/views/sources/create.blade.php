	...
	<br/>
		...
		<div id="accordion" class="panel-group">
			<div class="panel panel-default">
				...
				<div id="collapseOne" class="panel-collapse collapse">
					...
					{{ Form::open(array('action'=>'SourcesController@store', 'method'=>'post')) }}
						...
						<div class="form-group">
							<span class='glyphicon glyphicon-question-sign redish' data-toggle="popover" title="name" data-content="To inherit options from other sources, just add
								a ':' followed by the name of the source to inherit from."></span>&nbsp;<label for="s_name"><a href="http://sphinxsearch.com/docs/current.html#conf-sql-host">Source Name</a></label><br />
		 ...
		 @if ($source_type !== 'xmlpipe2' && $source_type !== 'tsvpipe')
					...
					<div class="form-group">
						<span class='glyphicon glyphicon-question-sign redish' data-toggle="popover" title="sql_query" data-content="This is the main query, used to fetch the data you want to index."></span>&nbsp;<label for="sql_query"><a href="http://sphinxsearch.com/docs/current.html#conf-sql-query">Main Query (mandatory)</a></label><br />
	...
	@endif
		     	<div class="panel panel-default">
					...
					<div id="collapseTwo" class="panel-collapse collapse">
						<div class="panel-body">
							<div class="form-group">	
								<span class='glyphicon glyphicon-question-sign redish' data-toggle="popover" title="sql_joined_field" data-content="UNIX socket name to connect to for local SQL servers. Optional, default value is empty (use client library default settings)."></span>&nbsp;<label for="sql_sock"><a href="http://sphinxsearch.com/docs/current.html#conf-sql-sock">UNIX Socket Name</a></label><br />
								<input type="text" name="sql_sock" placeholder="/tmp/mysql.sock">
							</div>

							<div class="form-group">
								<span class='glyphicon glyphicon-question-sign redish' data-toggle="popover" title="attributes" data-content="**Note that for xml and tsv source types, you'll 
								...
								field/attribute with a comma."></span>&nbsp;<label for="attributes"><a href="http://sphinxsearch.com/docs/current.html#attributes">Attributes</a> <br /></label><br />
		     ...
		     @endif
				...
				<div class="form-group">
					<span class='glyphicon glyphicon-question-sign redish' data-toggle="popover" title="sql_joined_field" data-content="Joined fields let you avoid JOIN and/or GROUP_CONCAT statements in the main document fetch query (sql_query). This can be useful when SQL-side JOIN is slow, or needs to be offloaded on Sphinx side, or simply to emulate MySQL-specific GROUP_CONCAT functionality in case your database server does not support it."></span>&nbsp;<label for="sql_joined_field"><a href="http://sphinxsearch.com/docs/current.html#conf-sql-joined-field">Joined Field(s)</a></label><br />
		...
		@endif
		 ...
		 @if ($source_type == 'xmlpipe2') 
					<div class="form-group">	
						<span class='glyphicon glyphicon-question-sign redish' data-toggle="popover" title="sql_query_range" data-content="Point to the directory of your xml file."></span>&nbsp;<label for="xmlpipe_command"><a href="http://sphinxsearch.com/docs/current.html#conf-xmlpipe-command">xml_command</a></label><br />
						<input type="text" name="xmlpipe_command" placeholder="cat /home/sphinx/test.xml"> 
					</div>
					<div class="form-group">	
						<span class='glyphicon glyphicon-question-sign redish' data-toggle="popover" title="xmlpipe_fixup_utf8" data-content="Perform Sphinx-side UTF-8 validation and filtering to prevent XML parser from choking on non-UTF-8 documents."></span>&nbsp;<label for="xmlpipe_fixup_utf8"><a href="http://sphinxsearch.com/docs/current.html#conf-xmlpipe-fixup-utf8">xml_fixup_utf8</a></label><br />
		 ...
		 @if ($source_type == 'tsvpipe')
					<div class="form-group">	
						<span class='glyphicon glyphicon-question-sign redish' data-toggle="popover" title="tsvpipe_command" data-content="Point to the directory of your tsv file"></span>&nbsp;<label for="tsvpipe_command"><a href="http://sphinxsearch.com/docs/current.html#tsvpipe">tsvpipe_command</a></label><br />
